...
RSpec.describe "SignUpProcesses", type: :system do
  ...
  it "requires the user to sign up and successfully creates an account" do
    visit root_path
  ...
  it "fails on invalid user information" do
    visit root_path
  ...
  it "fails on invalid account information" do
    visit root_path
